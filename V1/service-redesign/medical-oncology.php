<?php
$page_title = 'Medical Oncology & Cancer Care — Sukhda Medpark, Hisar';
$page_description = 'Precision medical oncology and compassionate cancer care at Sukhda Medpark, Hisar, including chemotherapy, immunotherapy, targeted therapy and multidisciplinary tumour board support.';
require dirname(__DIR__) . '/includes/header.php';
?>

<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Newsreader:ital,wght@0,400;0,500;1,400;1,500&display=swap" rel="stylesheet">
<style>
.medical-oncology-redesign { color: #0F172A; font-family: 'Plus Jakarta Sans', system-ui, sans-serif; -webkit-font-smoothing: antialiased;
    background: radial-gradient(900px 500px at 8% 4%, rgba(46,139,60,.05), transparent 60%), radial-gradient(900px 600px at 96% 46%, rgba(42,82,136,.05), transparent 60%), #F7FAF7; background-attachment: fixed; }
  .medical-oncology-redesign a { color: #2E8B3C; text-decoration: none; }
  .medical-oncology-redesign a:hover { color: #16A34A; }
  .medical-oncology-redesign em.serif { font-family: 'Newsreader', Georgia, serif; font-style: italic; font-weight: 400; font-size: 1.05em; letter-spacing: -0.01em; }
  .medical-oncology-redesign h1, .medical-oncology-redesign h2, .medical-oncology-redesign h3, .medical-oncology-redesign h4 { text-wrap: balance; }
  .medical-oncology-redesign p { text-wrap: pretty; }
  .medical-oncology-redesign section[id], .medical-oncology-redesign div[id] { scroll-margin-top: 88px; }
  .medical-oncology-redesign ::selection { background: rgba(125,203,107,.35); }

  .medical-oncology-redesign [data-anim] { transition: transform .3s cubic-bezier(.2,.7,.3,1), box-shadow .3s ease, border-color .3s ease, background .3s ease; box-shadow: 0 1px 2px rgba(11,30,60,.04), 0 12px 28px -24px rgba(11,30,60,.4); }
  .medical-oncology-redesign [data-anim]:hover { transform: translateY(-5px); border-color: #BFDCBF !important; box-shadow: 0 2px 4px rgba(11,30,60,.05), 0 30px 56px -28px rgba(11,30,60,.35); }
  .medical-oncology-redesign [data-treat] { position: relative; overflow: hidden; }
  .medical-oncology-redesign [data-treat]::before { content: ''; position: absolute; top: 0; left: 0; right: 0; height: 3px; background: linear-gradient(90deg, #16A34A, #7DCB6B); transform: scaleX(0); transform-origin: left; transition: transform .35s ease; }
  .medical-oncology-redesign [data-treat]:hover::before { transform: scaleX(1); }
  .medical-oncology-redesign [data-num] { position: absolute; top: 18px; right: 22px; font-size: 44px; font-weight: 800; letter-spacing: -0.04em; color: #12305F; opacity: .07; line-height: 1; pointer-events: none; }
  .medical-oncology-redesign [data-why] { position: relative; overflow: hidden; }
  .medical-oncology-redesign [data-why]::after { content: ''; position: absolute; left: 26px; right: 26px; bottom: 0; height: 2px; background: linear-gradient(90deg, #7DCB6B, transparent); transform: scaleX(0); transform-origin: left; transition: transform .35s ease; }
  .medical-oncology-redesign [data-why]:hover::after { transform: scaleX(1); }

  .medical-oncology-redesign a[href^="tel:"], .medical-oncology-redesign a[href="#contact"] { transition: transform .22s ease, box-shadow .22s ease, background .22s ease, border-color .22s ease, color .22s ease; }
  .medical-oncology-redesign a[href^="tel:"]:hover, .medical-oncology-redesign a[href="#contact"]:hover { transform: translateY(-2px); box-shadow: 0 18px 34px -14px rgba(11,30,60,.45); }

  .medical-oncology-redesign [data-nav] a { position: relative; transition: color .2s ease; }
  .medical-oncology-redesign [data-nav] a::after { content: ''; position: absolute; left: 0; right: 100%; bottom: -6px; height: 2px; border-radius: 2px; background: #16A34A; transition: right .25s ease; }
  .medical-oncology-redesign [data-nav] a:hover { color: #12305F; }
  .medical-oncology-redesign [data-nav] a:hover::after { right: 0; }
  .medical-oncology-redesign [data-index] a { transition: color .2s ease, padding-left .2s ease; }
  .medical-oncology-redesign [data-index] a:hover { color: #16A34A; padding-left: 6px; }
  .medical-oncology-redesign [data-faqq] { transition: color .2s ease, background .2s ease; }
  .medical-oncology-redesign [data-faqq]:hover { color: #16A34A; background: #FBFDFB; }
  .medical-oncology-redesign [data-canrow] { transition: background .2s ease, padding-left .2s ease; }
  .medical-oncology-redesign [data-canrow]:hover { background: #F0FDF4; padding-left: 10px; }

  .medical-oncology-redesign [data-grid-tex] { position: absolute; inset: 0; background-image: linear-gradient(rgba(255,255,255,.05) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,.05) 1px, transparent 1px); background-size: 56px 56px; mask-image: radial-gradient(circle at 32% 36%, #000, transparent 80%); }

  [data-reveal].rv { opacity: 0; transform: translateY(22px); }
  [data-reveal].rv-in { opacity: 1; transform: none; transition: opacity .7s ease, transform .7s cubic-bezier(.2,.7,.3,1); }

  @media (max-width: 1040px) {
    [data-g="hero"], [data-g="two"], [data-g="head"], [data-g="faq"], [data-g="cta"] { grid-template-columns: 1fr !important; }
    [data-g="head"] { gap: 20px !important; }
    [data-g="c3"] { grid-template-columns: repeat(2, 1fr) !important; }
    [data-g="j6"] { grid-template-columns: repeat(3, 1fr) !important; }
    [data-g="stats"] { grid-template-columns: repeat(2, 1fr) !important; }
    [data-nav] { display: none !important; }
    [data-statline] { display: none !important; }
  }
  @media (max-width: 720px) {
    [data-g="c3"], [data-g="quad"], [data-g="team"], [data-g="j6"], [data-g="cangrid"] { grid-template-columns: 1fr !important; }
    [data-pad] { padding-left: 20px !important; padding-right: 20px !important; }
    [data-g="stats"] { grid-template-columns: 1fr 1fr !important; }
  }
</style>

<div class="medical-oncology-redesign" style="min-height: 100vh;">
      ...
      <div data-g="hero" style="display: grid; grid-template-columns: 1.05fr .95fr; gap: 64px; align-items: center; padding-bottom: 64px;">
        <div>
          <div style="display: flex; align-items: center; gap: 8px; font-size: 13px; font-weight: 500; color: rgba(247,250,247,.55); margin-bottom: 26px;">
            <a href="/v1/" style="color: rgba(247,250,247,.75);">Home</a><span style="opacity: .4;">›</span>
          ...
          <div style="display: inline-flex; align-items: center; gap: 8px; background: rgba(125,203,107,.14); border: 1px solid rgba(125,203,107,.32); color: #7DCB6B; padding: 7px 16px; border-radius: 999px; font-size: 11.5px; font-weight: 700; letter-spacing: .13em; text-transform: uppercase; margin-bottom: 26px;"><i data-lucide="shield-check" style="width: 15px; height: 15px;"></i>Centre of Excellence</div>
          <h1 style="font-size: clamp(42px, 5.4vw, 66px); font-weight: 800; line-height: 1.04; letter-spacing: -0.038em; color: #FFFFFF; margin: 0 0 24px;">Fighting cancer with <em class="serif" style="color: #7DCB6B;">precision</em> &amp; <em class="serif" style="color: #7DCB6B;">compassion.</em></h1>
          <p style="font-size: 17.5px; line-height: 1.72; color: rgba(247,250,247,.82); max-width: 540px; margin: 0 0 36px;">Chemotherapy, immunotherapy and targeted therapy — planned by a weekly multidisciplinary tumour board, delivered in a dedicated daycare suite, and backed by round-the-clock supportive care.</p>
          <div style="display: flex; gap: 14px; flex-wrap: wrap; margin-bottom: 38px;">
            <a href="#contact" style="display: inline-flex; align-items: center; gap: 10px; background: linear-gradient(135deg, #16A34A, #15803D); color: #FFFFFF; padding: 16px 28px; border-radius: 13px; font-size: 15px; font-weight: 700; box-shadow: 0 16px 34px -12px rgba(22,163,74,.75);"><i data-lucide="calendar-check" style="width: 18px; height: 18px;"></i>Book oncology consult</a>
            <a href="tel:+919996544005" style="display: inline-flex; align-items: center; gap: 10px; background: rgba(255,255,255,.07); border: 1px solid rgba(255,255,255,.26); color: #FFFFFF; padding: 16px 28px; border-radius: 13px; font-size: 15px; font-weight: 700; backdrop-filter: blur(6px);"><i data-lucide="phone" style="width: 18px; height: 18px;"></i><?= htmlspecialchars($HOSPITAL['phone']) ?></a>
          </div>
        ...
        <div style="position: relative;">
          ...
          <div style="position: relative; border-radius: 22px; overflow: hidden; border: 1px solid rgba(255,255,255,.18); box-shadow: 0 40px 80px -30px rgba(0,0,0,.6);">
            <img src="/v1/assets/images/oncology/medical-oncology-redesign.jpg" alt="Oncology care at Sukhda Medpark" style="display: block; width: 100%; height: 440px; object-fit: cover;">
            ...
            <div style="position: absolute; left: 20px; right: 20px; bottom: 20px; display: flex; align-items: center; gap: 14px; background: rgba(247,250,247,.94); backdrop-filter: blur(10px); border-radius: 14px; padding: 16px 18px; color: #12305F;">
              <div style="width: 42px; height: 42px; flex: none; border-radius: 11px; background: #F0FDF4; border: 1px solid #BBF7D0; color: #16A34A; display: flex; align-items: center; justify-content: center;"><i data-lucide="microscope" style="width: 20px; height: 20px;"></i></div>
              <div>
          ...
          <div style="position: absolute; top: 18px; right: 18px; display: inline-flex; align-items: center; gap: 7px; background: rgba(11,30,60,.72); backdrop-filter: blur(8px); border: 1px solid rgba(125,203,107,.4); color: #7DCB6B; padding: 8px 14px; border-radius: 999px; font-size: 11px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase;"><i data-lucide="award" style="width: 14px; height: 14px;"></i>NABH Accredited</div>
        </div>
      </div>
  ...
  <section data-pad="1" style="max-width: 1240px; margin: 0 auto; padding: 80px 32px 0;">
    <div data-g="two" style="display: grid; grid-template-columns: 1.1fr .9fr; gap: 60px; align-items: start;">
      <div data-reveal="1">
        <div style="display: inline-flex; align-items: center; gap: 8px; background: #EAF3EA; color: #2E8B3C; padding: 7px 14px; border-radius: 999px; font-size: 11.5px; font-weight: 700; letter-spacing: .13em; text-transform: uppercase; margin-bottom: 18px;"><i data-lucide="building-2" style="width: 14px; height: 14px;"></i>About the department</div>
        <h2 style="font-size: clamp(30px, 3.4vw, 42px); font-weight: 800; line-height: 1.12; letter-spacing: -0.032em; color: #12305F; margin: 0 0 26px;">Comprehensive cancer care, <em class="serif" style="color: #2E8B3C;">under one roof.</em></h2>
        <p style="font-size: 16.5px; line-height: 1.78; color: #5B6480; margin: 0 0 18px;">The Department of Medical Oncology diagnoses, stages and treats solid-organ tumours and haematological malignancies using systemic therapies — from first biopsy to post-remission surveillance.</p>
        <div style="margin: 26px 0 28px; padding: 22px 26px; background: #FFFFFF; border-left: 4px solid #16A34A; border-radius: 0 16px 16px 0; box-shadow: 0 12px 28px -22px rgba(11,30,60,.35);">
          <p style="margin: 0; font-family: 'Newsreader', Georgia, serif; font-style: italic; font-size: 20px; line-height: 1.55; color: #12305F;">"No patient should have to travel to a metro city for world-class cancer treatment."</p>
          <div style="margin-top: 10px; font-size: 12.5px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; color: #2E8B3C;">— The principle we're built on</div>
        </div>
        <p style="font-size: 16.5px; line-height: 1.78; color: #5B6480; margin: 0 0 30px;">Every case is discussed in our <strong style="color: #12305F;">weekly multidisciplinary tumour board</strong> — medical, surgical and radiation oncologists, pathologists and radiologists designing each strategy together, so every decision is evidence-backed and protocol-driven.</p>
        <div data-g="quad" style="display: grid; grid-template-columns: 1fr 1fr; gap: 14px;">
          <div data-anim="1" style="display: flex; gap: 14px; padding: 18px; background: #F0FDF4; border: 1px solid #BBF7D0; border-radius: 14px;">
            <div style="width: 38px; height: 38px; flex: none; border-radius: 10px; background: linear-gradient(135deg, #16A34A, #15803D); color: #FFFFFF; display: flex; align-items: center; justify-content: center; box-shadow: 0 6px 12px -5px rgba(22,163,74,.55);"><i data-lucide="users" style="width: 18px; height: 18px;"></i></div>
            <div><strong style="display: block; font-size: 14.5px; color: #0F172A;">Tumour Board</strong><span style="display: block; font-size: 13px; line-height: 1.55; color: #5B6480; margin-top: 3px;">Weekly review by a multidisciplinary specialist panel</span></div>
          </div>
          <div data-anim="1" style="display: flex; gap: 14px; padding: 18px; background: #F0FDF4; border: 1px solid #BBF7D0; border-radius: 14px;">
            <div style="width: 38px; height: 38px; flex: none; border-radius: 10px; background: linear-gradient(135deg, #16A34A, #15803D); color: #FFFFFF; display: flex; align-items: center; justify-content: center; box-shadow: 0 6px 12px -5px rgba(22,163,74,.55);"><i data-lucide="test-tube" style="width: 18px; height: 18px;"></i></div>
            <div><strong style="display: block; font-size: 14.5px; color: #0F172A;">In-house Diagnostics</strong><span style="display: block; font-size: 13px; line-height: 1.55; color: #5B6480; margin-top: 3px;">NABL lab for histopathology, IHC &amp; tumour markers</span></div>
          </div>
          <div data-anim="1" style="display: flex; gap: 14px; padding: 18px; background: #F0FDF4; border: 1px solid #BBF7D0; border-radius: 14px;">
            <div style="width: 38px; height: 38px; flex: none; border-radius: 10px; background: linear-gradient(135deg, #16A34A, #15803D); color: #FFFFFF; display: flex; align-items: center; justify-content: center; box-shadow: 0 6px 12px -5px rgba(22,163,74,.55);"><i data-lucide="heart-handshake" style="width: 18px; height: 18px;"></i></div>
            <div><strong style="display: block; font-size: 14.5px; color: #0F172A;">Supportive Care</strong><span style="display: block; font-size: 13px; line-height: 1.55; color: #5B6480; margin-top: 3px;">Pain, nutrition, psycho-oncology &amp; palliative support</span></div>
          </div>
          <div data-anim="1" style="display: flex; gap: 14px; padding: 18px; background: #F0FDF4; border: 1px solid #BBF7D0; border-radius: 14px;">
            <div style="width: 38px; height: 38px; flex: none; border-radius: 10px; background: linear-gradient(135deg, #16A34A, #15803D); color: #FFFFFF; display: flex; align-items: center; justify-content: center; box-shadow: 0 6px 12px -5px rgba(22,163,74,.55);"><i data-lucide="shield-check" style="width: 18px; height: 18px;"></i></div>
            <div><strong style="display: block; font-size: 14.5px; color: #0F172A;">Protocol-Driven</strong><span style="display: block; font-size: 13px; line-height: 1.55; color: #5B6480; margin-top: 3px;">NCCN &amp; ESMO guidelines adapted for Indian patients</span></div>
          </div>
        </div>
      </div>
      ...
      <div style="position: sticky; top: 92px; display: flex; flex-direction: column; gap: 16px;">
        <div style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 20px; padding: 26px; box-shadow: 0 18px 44px -28px rgba(11,30,60,.35);">
          <div style="display: flex; align-items: center; gap: 10px; font-size: 16.5px; font-weight: 800; color: #12305F; margin-bottom: 16px; padding-bottom: 14px; border-bottom: 1px solid #E6EFE6;"><i data-lucide="list" style="width: 18px; height: 18px; color: #2E8B3C;"></i>What's on this page</div>
          <div data-index="1" style="display: flex; flex-direction: column;">
            <a href="#treatments" style="display: flex; align-items: center; gap: 12px; padding: 12px 0; border-bottom: 1px solid #F1F5F9; font-size: 14.5px; font-weight: 600; color: #2A5288;"><i data-lucide="pill" style="width: 17px; height: 17px; color: #2E8B3C;"></i>Treatments &amp; Therapies<i data-lucide="arrow-up-right" style="width: 14px; height: 14px; color: #BFDCBF; margin-left: auto;"></i></a>
            <a href="#cancers" style="display: flex; align-items: center; gap: 12px; padding: 12px 0; border-bottom: 1px solid #F1F5F9; font-size: 14.5px; font-weight: 600; color: #2A5288;"><i data-lucide="activity" style="width: 17px; height: 17px; color: #2E8B3C;"></i>Cancers We Treat<i data-lucide="arrow-up-right" style="width: 14px; height: 14px; color: #BFDCBF; margin-left: auto;"></i></a>
            <a href="#journey" style="display: flex; align-items: center; gap: 12px; padding: 12px 0; border-bottom: 1px solid #F1F5F9; font-size: 14.5px; font-weight: 600; color: #2A5288;"><i data-lucide="route" style="width: 17px; height: 17px; color: #2E8B3C;"></i>Your Patient Journey<i data-lucide="arrow-up-right" style="width: 14px; height: 14px; color: #BFDCBF; margin-left: auto;"></i></a>
            <a href="#why" style="display: flex; align-items: center; gap: 12px; padding: 12px 0; border-bottom: 1px solid #F1F5F9; font-size: 14.5px; font-weight: 600; color: #2A5288;"><i data-lucide="award" style="width: 17px; height: 17px; color: #2E8B3C;"></i>Why Choose Sukhda<i data-lucide="arrow-up-right" style="width: 14px; height: 14px; color: #BFDCBF; margin-left: auto;"></i></a>
            <a href="#team" style="display: flex; align-items: center; gap: 12px; padding: 12px 0; border-bottom: 1px solid #F1F5F9; font-size: 14.5px; font-weight: 600; color: #2A5288;"><i data-lucide="user-check" style="width: 17px; height: 17px; color: #2E8B3C;"></i>Our Specialists<i data-lucide="arrow-up-right" style="width: 14px; height: 14px; color: #BFDCBF; margin-left: auto;"></i></a>
            <a href="#faqs" style="display: flex; align-items: center; gap: 12px; padding: 12px 0; font-size: 14.5px; font-weight: 600; color: #2A5288;"><i data-lucide="help-circle" style="width: 17px; height: 17px; color: #2E8B3C;"></i>FAQs<i data-lucide="arrow-up-right" style="width: 14px; height: 14px; color: #BFDCBF; margin-left: auto;"></i></a>
          </div>
        </div>
        <div style="position: relative; overflow: hidden; background: linear-gradient(135deg, #0B1E3C, #1D4E7A); border-radius: 20px; padding: 28px; color: #F7FAF7;">
          ...
          <div style="position: relative;">
            <div style="display: inline-flex; align-items: center; gap: 7px; font-size: 11px; font-weight: 700; letter-spacing: .13em; text-transform: uppercase; color: #7DCB6B; margin-bottom: 12px;"><span style="width: 7px; height: 7px; border-radius: 50%; background: #7DCB6B; box-shadow: 0 0 0 4px rgba(125,203,107,.2);"></span>Helpline open now</div>
            ...
            <a href="tel:+919996544005" style="display: flex; align-items: center; justify-content: center; gap: 10px; background: linear-gradient(135deg, #16A34A, #15803D); color: #FFFFFF; padding: 14px 18px; border-radius: 13px; font-size: 15px; font-weight: 700; box-shadow: 0 12px 24px -10px rgba(22,163,74,.6);"><i data-lucide="phone" style="width: 17px; height: 17px;"></i><?= htmlspecialchars($HOSPITAL['phone']) ?></a>
  ...
  <section id="treatments" data-pad="1" style="max-width: 1240px; margin: 0 auto; padding: 92px 32px 0;">
    <div data-g="head" data-reveal="1" style="display: grid; grid-template-columns: 1fr 1fr; gap: 48px; align-items: end; margin-bottom: 40px;">
      <div>
        <div style="display: inline-flex; align-items: center; gap: 8px; background: #EAF3EA; color: #2E8B3C; padding: 7px 14px; border-radius: 999px; font-size: 11.5px; font-weight: 700; letter-spacing: .13em; text-transform: uppercase; margin-bottom: 18px;"><i data-lucide="pill" style="width: 14px; height: 14px;"></i>Treatment modalities</div>
        <h2 style="font-size: clamp(30px, 3.4vw, 42px); font-weight: 800; line-height: 1.12; letter-spacing: -0.032em; color: #12305F; margin: 0;">Treatments &amp; <em class="serif" style="color: #2E8B3C;">therapies we offer.</em></h2>
      </div>
      <p style="font-size: 16px; line-height: 1.75; color: #5B6480; margin: 0;">Every cancer is unique. Our oncologists tailor plans by combining modalities — chemotherapy, immunotherapy, targeted agents and supportive care — to maximise response while minimising side effects.</p>
    </div>
    <div data-g="c3" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
      <article data-anim="1" data-treat="1" data-reveal="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 20px; padding: 32px 28px; display: flex; flex-direction: column; gap: 16px;">
        ...
        <div style="width: 52px; height: 52px; border-radius: 14px; background: #EBF3FC; border: 1px solid #BFDBFE; color: #0F4F94; display: flex; align-items: center; justify-content: center;"><i data-lucide="pill" style="width: 25px; height: 25px;"></i></div>
      ...
      <article data-anim="1" data-treat="1" data-reveal="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 20px; padding: 32px 28px; display: flex; flex-direction: column; gap: 16px;">
        ...
        <div style="width: 52px; height: 52px; border-radius: 14px; background: #F0FDF4; border: 1px solid #BBF7D0; color: #16A34A; display: flex; align-items: center; justify-content: center;"><i data-lucide="shield-check" style="width: 25px; height: 25px;"></i></div>
      ...
      <article data-anim="1" data-treat="1" data-reveal="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 20px; padding: 32px 28px; display: flex; flex-direction: column; gap: 16px;">
        ...
        <div style="width: 52px; height: 52px; border-radius: 14px; background: #F5F3FF; border: 1px solid #DDD6FE; color: #7C3AED; display: flex; align-items: center; justify-content: center;"><i data-lucide="target" style="width: 25px; height: 25px;"></i></div>
      ...
      <article data-anim="1" data-treat="1" data-reveal="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 20px; padding: 32px 28px; display: flex; flex-direction: column; gap: 16px;">
        ...
        <div style="width: 52px; height: 52px; border-radius: 14px; background: #FFFBEB; border: 1px solid #FDE68A; color: #D97706; display: flex; align-items: center; justify-content: center;"><i data-lucide="dna" style="width: 25px; height: 25px;"></i></div>
      ...
      <article data-anim="1" data-treat="1" data-reveal="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 20px; padding: 32px 28px; display: flex; flex-direction: column; gap: 16px;">
        ...
        <div style="width: 52px; height: 52px; border-radius: 14px; background: #FFF1F2; border: 1px solid #FECDD3; color: #E11D48; display: flex; align-items: center; justify-content: center;"><i data-lucide="heart-handshake" style="width: 25px; height: 25px;"></i></div>
      ...
      <article data-anim="1" data-treat="1" data-reveal="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 20px; padding: 32px 28px; display: flex; flex-direction: column; gap: 16px;">
        ...
        <div style="width: 52px; height: 52px; border-radius: 14px; background: #F0FDFA; border: 1px solid #99F6E4; color: #0D9488; display: flex; align-items: center; justify-content: center;"><i data-lucide="armchair" style="width: 25px; height: 25px;"></i></div>
  ...
  <section id="cancers" data-pad="1" style="max-width: 1240px; margin: 0 auto; padding: 92px 32px 0;">
    <div data-g="head" data-reveal="1" style="display: grid; grid-template-columns: 1fr 1fr; gap: 48px; align-items: end; margin-bottom: 40px;">
      <div>
        <div style="display: inline-flex; align-items: center; gap: 8px; background: #EAF3EA; color: #2E8B3C; padding: 7px 14px; border-radius: 999px; font-size: 11.5px; font-weight: 700; letter-spacing: .13em; text-transform: uppercase; margin-bottom: 18px;"><i data-lucide="activity" style="width: 14px; height: 14px;"></i>Scope of care</div>
        <h2 style="font-size: clamp(30px, 3.4vw, 42px); font-weight: 800; line-height: 1.12; letter-spacing: -0.032em; color: #12305F; margin: 0;">Cancers <em class="serif" style="color: #2E8B3C;">we treat.</em></h2>
      </div>
      <p style="font-size: 16px; line-height: 1.75; color: #5B6480; margin: 0;">The full spectrum of solid-organ tumours and haematological malignancies across all stages — from early-stage curative intent to advanced palliative management.</p>
    </div>
    <div data-g="cangrid" data-reveal="1" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
      <div data-anim="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 20px; padding: 28px 26px;">
        <div style="display: flex; align-items: center; gap: 12px; padding-bottom: 16px; margin-bottom: 8px; border-bottom: 2px solid #EAF3EA;">
          <div style="width: 42px; height: 42px; border-radius: 12px; background: #EBF3FC; border: 1px solid #BFDBFE; color: #0F4F94; display: flex; align-items: center; justify-content: center;"><i data-lucide="scan" style="width: 20px; height: 20px;"></i></div>
          <div>
      ...
      <div data-anim="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 20px; padding: 28px 26px;">
        <div style="display: flex; align-items: center; gap: 12px; padding-bottom: 16px; margin-bottom: 8px; border-bottom: 2px solid #EAF3EA;">
          <div style="width: 42px; height: 42px; border-radius: 12px; background: #F0FDF4; border: 1px solid #BBF7D0; color: #16A34A; display: flex; align-items: center; justify-content: center;"><i data-lucide="droplets" style="width: 20px; height: 20px;"></i></div>
          <div>
        ...
        <div style="margin-top: 18px; padding: 14px 16px; background: #F0FDF4; border: 1px dashed #BBF7D0; border-radius: 12px; font-size: 12.5px; line-height: 1.6; color: #15803D;"><strong>Note:</strong> Complete haematology work-up with same-day CBC, peripheral smear and bone-marrow reporting in our NABL lab.</div>
      </div>
      <div data-anim="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 20px; padding: 28px 26px;">
        <div style="display: flex; align-items: center; gap: 12px; padding-bottom: 16px; margin-bottom: 8px; border-bottom: 2px solid #EAF3EA;">
          <div style="width: 42px; height: 42px; border-radius: 12px; background: #F5F3FF; border: 1px solid #DDD6FE; color: #7C3AED; display: flex; align-items: center; justify-content: center;"><i data-lucide="ribbon" style="width: 20px; height: 20px;"></i></div>
          <div>
  ...
  <div id="why" style="margin-top: 96px; position: relative; overflow: hidden; background: linear-gradient(135deg, #0F2B54 0%, #2A5288 100%); color: #F7FAF7; padding: 88px 0; border-top: 3px solid #7DCB6B;">
    ...
    <div data-pad="1" style="position: relative; z-index: 2; max-width: 1240px; margin: 0 auto; padding: 0 32px;">
      <div data-g="head" data-reveal="1" style="display: grid; grid-template-columns: 1fr 1fr; gap: 48px; align-items: end; margin-bottom: 42px;">
        <div>
          <div style="display: inline-flex; align-items: center; gap: 8px; background: rgba(125,203,107,.14); border: 1px solid rgba(125,203,107,.3); color: #7DCB6B; padding: 7px 14px; border-radius: 999px; font-size: 11.5px; font-weight: 700; letter-spacing: .13em; text-transform: uppercase; margin-bottom: 18px;"><i data-lucide="award" style="width: 14px; height: 14px;"></i>Why Sukhda</div>
          <h2 style="font-size: clamp(30px, 3.4vw, 42px); font-weight: 800; line-height: 1.12; letter-spacing: -0.032em; color: #FFFFFF; margin: 0;">Why families choose <em class="serif" style="color: #7DCB6B;">Sukhda for cancer care.</em></h2>
        </div>
        <p style="font-size: 16px; line-height: 1.75; color: rgba(247,250,247,.78); margin: 0;">We combine clinical rigour with genuine compassion. Here's what sets our cancer centre apart from other hospitals in the region.</p>
      </div>
      <div data-g="c3" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 18px;">
        <div data-why="1" data-reveal="1" style="background: rgba(255,255,255,.055); border: 1px solid rgba(255,255,255,.13); border-radius: 18px; padding: 30px 26px; backdrop-filter: blur(4px);">
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 18px;">
            <div style="width: 46px; height: 46px; border-radius: 13px; background: rgba(125,203,107,.15); color: #7DCB6B; display: flex; align-items: center; justify-content: center;"><i data-lucide="users" style="width: 22px; height: 22px;"></i></div>
        ...
        <div data-why="1" data-reveal="1" style="background: rgba(255,255,255,.055); border: 1px solid rgba(255,255,255,.13); border-radius: 18px; padding: 30px 26px; backdrop-filter: blur(4px);">
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 18px;">
            <div style="width: 46px; height: 46px; border-radius: 13px; background: rgba(125,203,107,.15); color: #7DCB6B; display: flex; align-items: center; justify-content: center;"><i data-lucide="map-pin" style="width: 22px; height: 22px;"></i></div>
        ...
        <div data-why="1" data-reveal="1" style="background: rgba(255,255,255,.055); border: 1px solid rgba(255,255,255,.13); border-radius: 18px; padding: 30px 26px; backdrop-filter: blur(4px);">
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 18px;">
            <div style="width: 46px; height: 46px; border-radius: 13px; background: rgba(125,203,107,.15); color: #7DCB6B; display: flex; align-items: center; justify-content: center;"><i data-lucide="indian-rupee" style="width: 22px; height: 22px;"></i></div>
        ...
        <div data-why="1" data-reveal="1" style="background: rgba(255,255,255,.055); border: 1px solid rgba(255,255,255,.13); border-radius: 18px; padding: 30px 26px; backdrop-filter: blur(4px);">
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 18px;">
            <div style="width: 46px; height: 46px; border-radius: 13px; background: rgba(125,203,107,.15); color: #7DCB6B; display: flex; align-items: center; justify-content: center;"><i data-lucide="heart" style="width: 22px; height: 22px;"></i></div>
        ...
        <div data-why="1" data-reveal="1" style="background: rgba(255,255,255,.055); border: 1px solid rgba(255,255,255,.13); border-radius: 18px; padding: 30px 26px; backdrop-filter: blur(4px);">
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 18px;">
            <div style="width: 46px; height: 46px; border-radius: 13px; background: rgba(125,203,107,.15); color: #7DCB6B; display: flex; align-items: center; justify-content: center;"><i data-lucide="flask-conical" style="width: 22px; height: 22px;"></i></div>
        ...
        <div data-why="1" data-reveal="1" style="background: rgba(255,255,255,.055); border: 1px solid rgba(255,255,255,.13); border-radius: 18px; padding: 30px 26px; backdrop-filter: blur(4px);">
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 18px;">
            <div style="width: 46px; height: 46px; border-radius: 13px; background: rgba(125,203,107,.15); color: #7DCB6B; display: flex; align-items: center; justify-content: center;"><i data-lucide="zap" style="width: 22px; height: 22px;"></i></div>
  ...
  <section id="journey" data-pad="1" style="max-width: 1240px; margin: 0 auto; padding: 92px 32px 0;">
    <div data-g="head" data-reveal="1" style="display: grid; grid-template-columns: 1fr 1fr; gap: 48px; align-items: end; margin-bottom: 48px;">
      <div>
        <div style="display: inline-flex; align-items: center; gap: 8px; background: #EAF3EA; color: #2E8B3C; padding: 7px 14px; border-radius: 999px; font-size: 11.5px; font-weight: 700; letter-spacing: .13em; text-transform: uppercase; margin-bottom: 18px;"><i data-lucide="route" style="width: 14px; height: 14px;"></i>Patient journey</div>
        <h2 style="font-size: clamp(30px, 3.4vw, 42px); font-weight: 800; line-height: 1.12; letter-spacing: -0.032em; color: #12305F; margin: 0;">Your path through <em class="serif" style="color: #2E8B3C;">cancer treatment.</em></h2>
      </div>
      <p style="font-size: 16px; line-height: 1.75; color: #5B6480; margin: 0;">From your first consultation to long-term survivorship monitoring, here's exactly how we guide you through every stage of care at Sukhda.</p>
    </div>
    <div style="position: relative;">
  ...
  <section id="team" data-pad="1" style="max-width: 1240px; margin: 0 auto; padding: 92px 32px 0;">
    <div data-g="head" data-reveal="1" style="display: grid; grid-template-columns: 1fr 1fr; gap: 48px; align-items: end; margin-bottom: 40px;">
      <div>
        <div style="display: inline-flex; align-items: center; gap: 8px; background: #EAF3EA; color: #2E8B3C; padding: 7px 14px; border-radius: 999px; font-size: 11.5px; font-weight: 700; letter-spacing: .13em; text-transform: uppercase; margin-bottom: 18px;"><i data-lucide="user-check" style="width: 14px; height: 14px;"></i>Our team</div>
        <h2 style="font-size: clamp(30px, 3.4vw, 42px); font-weight: 800; line-height: 1.12; letter-spacing: -0.032em; color: #12305F; margin: 0;">Meet our <em class="serif" style="color: #2E8B3C;">oncology experts.</em></h2>
      </div>
      <p style="font-size: 16px; line-height: 1.75; color: #5B6480; margin: 0;">Experienced medical oncologists, nursing staff trained in onco-care and allied health professionals dedicated to fighting cancer alongside you.</p>
    </div>
  ...
  <section id="faqs" data-pad="1" style="max-width: 1240px; margin: 0 auto; padding: 92px 32px 0;">
    <div data-g="faq" style="display: grid; grid-template-columns: .85fr 1.15fr; gap: 48px; align-items: start;">
      <div data-reveal="1" style="position: sticky; top: 92px;">
        <div style="display: inline-flex; align-items: center; gap: 8px; background: #EAF3EA; color: #2E8B3C; padding: 7px 14px; border-radius: 999px; font-size: 11.5px; font-weight: 700; letter-spacing: .13em; text-transform: uppercase; margin-bottom: 18px;"><i data-lucide="help-circle" style="width: 14px; height: 14px;"></i>FAQs</div>
        <h2 style="font-size: clamp(30px, 3.4vw, 42px); font-weight: 800; line-height: 1.12; letter-spacing: -0.032em; color: #12305F; margin: 0 0 18px;">Common <em class="serif" style="color: #2E8B3C;">questions answered.</em></h2>
        <p style="font-size: 16px; line-height: 1.75; color: #5B6480; margin: 0 0 26px;">We understand a cancer diagnosis brings many questions. Here are answers to the ones our patients ask most.</p>
        <div style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 18px; padding: 22px 24px; box-shadow: 0 14px 32px -26px rgba(11,30,60,.4);">
          <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 6px;">
            <div style="width: 40px; height: 40px; border-radius: 11px; background: #F0FDF4; border: 1px solid #BBF7D0; color: #16A34A; display: flex; align-items: center; justify-content: center;"><i data-lucide="message-circle-question" style="width: 19px; height: 19px;"></i></div>
          ...
          <a href="tel:+919996544005" style="display: inline-flex; align-items: center; gap: 9px; font-size: 14.5px; font-weight: 800; color: #15803D;"><i data-lucide="phone" style="width: 16px; height: 16px;"></i><?= htmlspecialchars($HOSPITAL['phone']) ?></a>
        </div>
      </div>
      <div style="display: flex; flex-direction: column; gap: 12px;">
        <div data-reveal="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 26px -24px rgba(11,30,60,.4);">
          <button type="button" data-faqq="1"  style="width: 100%; background: none; border: 0; padding: 21px 24px; display: flex; align-items: center; justify-content: space-between; gap: 16px; cursor: pointer; text-align: left; font-family: inherit; font-size: 15.5px; font-weight: 700; color: #12305F;">What is the difference between chemotherapy and immunotherapy?<span data-chevwrap="1" style="width: 30px; height: 30px; flex: none; border-radius: 9px; background: #F0FDF4; border: 1px solid #BBF7D0; display: flex; align-items: center; justify-content: center;"><i data-lucide="plus" data-chev="1" style="width: 16px; height: 16px; color: #16A34A; transition: transform .25s ease;"></i></span></button>
          <div data-faq-body="1" style="display: none; padding: 0 24px 22px; font-size: 14.5px; line-height: 1.75; color: #5B6480;">Chemotherapy uses cytotoxic drugs to directly kill rapidly dividing cancer cells, which can also affect normal cells and cause side effects such as hair loss and nausea. Immunotherapy instead stimulates the body's own immune system to recognise and attack cancer cells specifically, often with a different side-effect profile. Your oncologist will determine which approach — or combination — suits your cancer type and biomarker profile.</div>
        </div>
        <div data-reveal="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 26px -24px rgba(11,30,60,.4);">
          <button type="button" data-faqq="1"  style="width: 100%; background: none; border: 0; padding: 21px 24px; display: flex; align-items: center; justify-content: space-between; gap: 16px; cursor: pointer; text-align: left; font-family: inherit; font-size: 15.5px; font-weight: 700; color: #12305F;">How long does a typical chemotherapy session take?<span data-chevwrap="1" style="width: 30px; height: 30px; flex: none; border-radius: 9px; background: #F0FDF4; border: 1px solid #BBF7D0; display: flex; align-items: center; justify-content: center;"><i data-lucide="plus" data-chev="1" style="width: 16px; height: 16px; color: #16A34A; transition: transform .25s ease;"></i></span></button>
          <div data-faq-body="1" style="display: none; padding: 0 24px 22px; font-size: 14.5px; line-height: 1.75; color: #5B6480;">A single session in our daycare suite typically takes two to six hours, depending on the drug regimen. That includes pre-medication to prevent nausea, the infusion itself and a short observation period afterwards. Most patients return home the same day, on a schedule your oncologist sets out in advance.</div>
        </div>
        <div data-reveal="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 26px -24px rgba(11,30,60,.4);">
          <button type="button" data-faqq="1"  style="width: 100%; background: none; border: 0; padding: 21px 24px; display: flex; align-items: center; justify-content: space-between; gap: 16px; cursor: pointer; text-align: left; font-family: inherit; font-size: 15.5px; font-weight: 700; color: #12305F;">Will I lose my hair during cancer treatment?<span data-chevwrap="1" style="width: 30px; height: 30px; flex: none; border-radius: 9px; background: #F0FDF4; border: 1px solid #BBF7D0; display: flex; align-items: center; justify-content: center;"><i data-lucide="plus" data-chev="1" style="width: 16px; height: 16px; color: #16A34A; transition: transform .25s ease;"></i></span></button>
          <div data-faq-body="1" style="display: none; padding: 0 24px 22px; font-size: 14.5px; line-height: 1.75; color: #5B6480;">It depends on the specific drugs used. Many traditional chemotherapy agents cause temporary hair loss that reverses after treatment ends, while newer targeted therapies and immunotherapies often cause little or none. Our team will discuss the expected effects of your regimen and the support available, including scalp cooling where applicable.</div>
        </div>
        <div data-reveal="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 26px -24px rgba(11,30,60,.4);">
          <button type="button" data-faqq="1"  style="width: 100%; background: none; border: 0; padding: 21px 24px; display: flex; align-items: center; justify-content: space-between; gap: 16px; cursor: pointer; text-align: left; font-family: inherit; font-size: 15.5px; font-weight: 700; color: #12305F;">What is a tumour board and why is it important?<span data-chevwrap="1" style="width: 30px; height: 30px; flex: none; border-radius: 9px; background: #F0FDF4; border: 1px solid #BBF7D0; display: flex; align-items: center; justify-content: center;"><i data-lucide="plus" data-chev="1" style="width: 16px; height: 16px; color: #16A34A; transition: transform .25s ease;"></i></span></button>
          <div data-faq-body="1" style="display: none; padding: 0 24px 22px; font-size: 14.5px; line-height: 1.75; color: #5B6480;">A tumour board is a weekly conference where your case is reviewed by medical, surgical and radiation oncologists together with pathologists and radiologists. This collaborative approach considers every angle, combines evidence from multiple disciplines and avoids single-doctor bias. Reviews of this kind are consistently associated with better treatment outcomes.</div>
        </div>
        <div data-reveal="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 26px -24px rgba(11,30,60,.4);">
          <button type="button" data-faqq="1"  style="width: 100%; background: none; border: 0; padding: 21px 24px; display: flex; align-items: center; justify-content: space-between; gap: 16px; cursor: pointer; text-align: left; font-family: inherit; font-size: 15.5px; font-weight: 700; color: #12305F;">Does Sukhda accept health insurance for cancer treatment?<span data-chevwrap="1" style="width: 30px; height: 30px; flex: none; border-radius: 9px; background: #F0FDF4; border: 1px solid #BBF7D0; display: flex; align-items: center; justify-content: center;"><i data-lucide="plus" data-chev="1" style="width: 16px; height: 16px; color: #16A34A; transition: transform .25s ease;"></i></span></button>
          <div data-faq-body="1" style="display: none; padding: 0 24px 22px; font-size: 14.5px; line-height: 1.75; color: #5B6480;">Yes. Sukhda Medpark is empanelled with major TPA insurance providers and offers cashless hospitalisation for eligible policies. Our dedicated billing and insurance desk assists with pre-authorisation, documentation and claims processing, so you can focus on recovery rather than paperwork.</div>
        </div>
        <div data-reveal="1" style="background: #FFFFFF; border: 1px solid #DCE6DC; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 26px -24px rgba(11,30,60,.4);">
          <button type="button" data-faqq="1"  style="width: 100%; background: none; border: 0; padding: 21px 24px; display: flex; align-items: center; justify-content: space-between; gap: 16px; cursor: pointer; text-align: left; font-family: inherit; font-size: 15.5px; font-weight: 700; color: #12305F;">What should I bring to my first oncology consultation?<span data-chevwrap="1" style="width: 30px; height: 30px; flex: none; border-radius: 9px; background: #F0FDF4; border: 1px solid #BBF7D0; display: flex; align-items: center; justify-content: center;"><i data-lucide="plus" data-chev="1" style="width: 16px; height: 16px; color: #16A34A; transition: transform .25s ease;"></i></span></button>
          <div data-faq-body="1" style="display: none; padding: 0 24px 22px; font-size: 14.5px; line-height: 1.75; color: #5B6480;">Please bring all previous medical reports (blood work, biopsy reports, CT/MRI/PET imaging), treatment records from other hospitals, a list of current medications, your health insurance card if applicable, and a family member or companion. Arriving fifteen minutes early helps complete registration smoothly.</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <div id="contact" style="margin-top: 96px; position: relative; overflow: hidden; background: linear-gradient(135deg, #0B1E3C 0%, #163A66 100%); color: #F7FAF7; padding: 88px 0; border-top: 3px solid #7DCB6B;">
    ...
    <div data-pad="1" style="position: relative; z-index: 2; max-width: 1240px; margin: 0 auto; padding: 0 32px;">
      <div data-g="cta" style="display: grid; grid-template-columns: 1.2fr .8fr; gap: 56px; align-items: center;">
        <div data-reveal="1">
          <div style="display: inline-flex; align-items: center; gap: 8px; background: rgba(125,203,107,.14); border: 1px solid rgba(125,203,107,.3); color: #7DCB6B; padding: 7px 14px; border-radius: 999px; font-size: 11.5px; font-weight: 700; letter-spacing: .13em; text-transform: uppercase; margin-bottom: 22px;"><i data-lucide="calendar-heart" style="width: 14px; height: 14px;"></i>Take the first step</div>
          <h2 style="font-size: clamp(32px, 4vw, 50px); font-weight: 800; line-height: 1.1; letter-spacing: -0.032em; color: #FFFFFF; margin: 0 0 18px;">Start your journey to <em class="serif" style="color: #7DCB6B;">recovery today.</em></h2>
          <p style="font-size: 16.5px; line-height: 1.72; color: rgba(247,250,247,.78); margin: 0 0 32px; max-width: 520px;">Our oncology specialists are available seven days a week. Schedule a consultation or speak to our cancer care coordinator for guidance on next steps.</p>
          <div style="display: flex; gap: 14px; flex-wrap: wrap;">
            <a href="/v1/#contact" style="display: inline-flex; align-items: center; gap: 10px; background: linear-gradient(135deg, #16A34A, #15803D); color: #FFFFFF; padding: 16px 28px; border-radius: 13px; font-size: 15px; font-weight: 700; box-shadow: 0 16px 34px -12px rgba(22,163,74,.75);"><i data-lucide="calendar-check" style="width: 18px; height: 18px;"></i>Book consultation</a>
            <a href="tel:+919996544005" style="display: inline-flex; align-items: center; gap: 10px; background: rgba(255,255,255,.07); border: 1px solid rgba(255,255,255,.28); color: #FFFFFF; padding: 16px 28px; border-radius: 13px; font-size: 15px; font-weight: 700;"><i data-lucide="phone" style="width: 18px; height: 18px;"></i><?= htmlspecialchars($HOSPITAL['phone']) ?></a>
          </div>
        </div>
        <div data-reveal="1" style="background: rgba(255,255,255,.06); backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,.15); border-radius: 20px; padding: 30px;">
          ...
          <div style="display: flex; flex-direction: column; gap: 18px;">
            <div style="display: flex; gap: 14px;">
              ...
              <div><div style="font-size: 14.5px; font-weight: 700; color: #FFFFFF;">Sukhda Medpark, Hisar</div><div style="font-size: 13px; color: rgba(247,250,247,.65); margin-top: 3px;">Haryana, India</div></div>
            </div>
            <div style="display: flex; gap: 14px;">
              <i data-lucide="clock" style="width: 19px; height: 19px; color: #7DCB6B; flex: none; margin-top: 2px;"></i>
              <div><div style="font-size: 14.5px; font-weight: 700; color: #FFFFFF;">OPD: Mon–Sat, 9 am – 5 pm</div><div style="font-size: 13px; color: rgba(247,250,247,.65); margin-top: 3px;">Emergency &amp; helpline: 24×7, all days</div></div>
            </div>
            <div style="display: flex; gap: 14px;">
              <i data-lucide="phone-call" style="width: 19px; height: 19px; color: #7DCB6B; flex: none; margin-top: 2px;"></i>
              <div><div style="font-size: 14.5px; font-weight: 700; color: #FFFFFF;"><?= htmlspecialchars($HOSPITAL['phone']) ?></div><div style="font-size: 13px; color: rgba(247,250,247,.65); margin-top: 3px;">Cancer care coordinator</div></div>
            </div>
          </div>
        </div>
      </div>
...
<script>
(function () {
  function initialiseOncologyPage() {
    if (window.lucide) window.lucide.createIcons();

    var revealItems = document.querySelectorAll('.medical-oncology-redesign [data-reveal]');
    ...
    document.querySelectorAll('.medical-oncology-redesign [data-faqq]').forEach(function (button) {
      button.addEventListener('click', function () {
        var card = button.parentElement;
        var answer = card.querySelector('[data-faq-body]');
        var icon = button.querySelector('[data-chev]');
        if (!answer) return;
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initialiseOncologyPage);
  } else {
    initialiseOncologyPage();
  }
})();
</script>
