...
<section id="specialties" class="relative py-14 lg:py-24 bg-mist/60 overflow-hidden" x-data="{
           tab: 'Treatments',
           searchQuery: '',
           selectedItem: null,
  ...
  <div class="relative max-w-7xl mx-auto px-6 lg:px-8">
    ...
    <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-8 pb-10 border-b border-brand-200/60">
      <div class="max-w-2xl">
        ...
        <h2
          class="font-display text-xl sm:text-2xl lg:text-3xl leading-[1.15] font-semibold text-ink tracking-tight">
          Comprehensive medical care across <span class="italic text-brand-600"><?= count($SPECIALTIES) ?> specialised
            wings.</span>
        </h2>
      </div>
    ...
    <div
      ...
      <div class="relative z-10 max-w-xl text-center lg:text-left">
        ...
        <h3 class="font-display text-xl sm:text-2xl lg:text-3xl font-semibold leading-tight text-white">
...
============================================================ -->
<section id="about" class="relative py-16 lg:py-24 bg-mist overflow-hidden" x-data="{
  ...
  <div class="relative max-w-7xl mx-auto px-6 lg:px-8">
    ...
    <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-8 pb-10 border-b border-brand-200/60">
      <div class="max-w-3xl">
        ...
        <h2
          class="font-display text-xl sm:text-2xl lg:text-3xl leading-[1.15] font-semibold text-ink tracking-tight text-balance">
    ...
    <div x-show="tab === 'story'" x-transition:enter="transition ease-out duration-500"
      ...
      <div class="lg:col-span-6 space-y-6">
        ...
        <div class="p-6 rounded-3xl bg-white border border-brand-200 shadow-soft relative overflow-hidden">
          ...
          <p class="italic text-brand-900 font-display text-base lg:text-lg leading-relaxed relative z-10">
      ...
      <div
        ...
        <div class="relative aspect-video w-full rounded-2xl overflow-hidden bg-black shadow-glow">
          <iframe class="absolute inset-0 w-full h-full border-0"
            src="https://www.youtube-nocookie.com/embed/5qap5aO4i9A?rel=0&modestbranding=1" title="Sukhda Hospital Tour"
...
<section id="technology" class="relative py-16 lg:py-24 bg-white overflow-hidden" x-data="{
  ...
  <div
    class="absolute -top-32 -right-32 w-[480px] h-[480px] rounded-full bg-brand-50 blur-3xl opacity-80 pointer-events-none">
  </div>
  <div
    class="absolute -bottom-32 -left-32 w-[480px] h-[480px] rounded-full bg-coral-50 blur-3xl opacity-70 pointer-events-none">
  </div>

  <div class="relative max-w-7xl mx-auto px-6 lg:px-8">

    <!-- Section Header (Centered, Tabs Removed) -->
    <div class="text-center max-w-3xl mx-auto pb-10 border-b border-brand-200/60">
      <div class="flex justify-center mb-3.5">
        <span
          ...
          <i data-lucide="cpu" class="w-3.5 h-3.5 text-brand-600"></i> World-Class Technology &amp; Diagnostics
        </span>
      </div>
      <h2
        class="font-display text-xl sm:text-2xl lg:text-3xl leading-[1.15] font-semibold text-ink tracking-tight text-balance mx-auto">
      ...
      <?php foreach ($TECH as $i => $t):
        ...
        ?>
            <article
              ...
              class="group relative rounded-3xl bg-white border border-brand-200/80 overflow-hidden shadow-soft hover:shadow-glow hover:border-brand-400 hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between cursor-pointer">
              ...
              <div>
                ...
                <div class="relative aspect-[16/10] overflow-hidden bg-mist">
                  ...
                  <div
                    class="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-brand-900/70 via-brand-900/20 to-transparent">
                  </div>
                ...
                <div class="p-6">
                  <h3
                    class="font-display text-xl font-bold text-brand-900 leading-snug group-hover:text-coral-600 transition">
                    <?= htmlspecialchars($t['name']) ?>
                  </h3>
                  <p class="mt-2 text-xs text-ink/70 leading-relaxed line-clamp-3">
                    <?= htmlspecialchars($t['desc']) ?>
                  </p>

                  <!-- Quick Spec Highlights -->
                  <div
                    class="mt-4 pt-3 border-t border-brand-100/80 flex items-center gap-2 text-[11px] font-semibold text-brand-700 truncate">
                    <i data-lucide="shield-check" class="w-3.5 h-3.5 text-brand-600 shrink-0"></i>
...
<section id="rare-cases" class="relative py-16 lg:py-24 bg-brand-900 text-white overflow-hidden" x-data="{
           activeCase: 0,
           filterDept: 'ALL',
           viewMode: 'cards',
  ...
  <div class="relative max-w-7xl mx-auto px-6 lg:px-8">
    ...
    <div class="text-center max-w-4xl mx-auto pb-8">
      ...
      <h2
        class="font-display text-xl sm:text-2xl lg:text-3xl leading-[1.15] font-bold text-white tracking-tight text-balance mx-auto">
        Extraordinary recoveries, engineered by <span class="italic text-coral-400 font-normal">multidisciplinary
          mastery.</span>
      </h2>
    ...
    <div id="miracle-consult"
      ...
      <div class="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div class="lg:col-span-7 space-y-3">
          ...
          <h3 class="font-display text-xl sm:text-2xl lg:text-3xl font-semibold text-white leading-tight">
...
============================================================ -->
<section id="testimonials" class="relative py-16 lg:py-24 bg-[#eef8f5] text-brand-950 overflow-hidden">
  <!-- Soft Ambient Glows -->
  ...
  <div class="relative max-w-7xl mx-auto px-6 lg:px-8" x-data="{
    ...
    <div class="text-center max-w-3xl mx-auto pb-10 border-b border-brand-200/60 mb-10 lg:mb-14">
      ...
      <h2
        class="font-display text-xl sm:text-2xl lg:text-3xl leading-[1.15] font-semibold text-ink tracking-tight text-balance mx-auto">
        Real patients, <span class="italic text-brand-600">real recovery stories.</span>
      </h2>
      <p class="mt-3.5 text-ink/70 leading-relaxed text-[15px] sm:text-base max-w-2xl mx-auto">
      ...
      <div x-show="activeVideoModal !== null" @click.away="activeVideoModal = null"
        ...
        <div class="relative aspect-[16/9] w-full rounded-2xl overflow-hidden bg-black shadow-2xl ring-1 ring-white/10 mb-6">
          <template x-if="activeVideoModal !== null">
            <iframe class="absolute inset-0 w-full h-full border-0"
              :src="`https://www.youtube-nocookie.com/embed/${activeVideoModal?.youtube}?rel=0&modestbranding=1&playsinline=1&autoplay=1`"
...
============================================================ -->
<section id="events" class="relative py-14 lg:py-20 bg-white overflow-hidden">
  <div class="max-w-7xl mx-auto px-6 lg:px-8" x-data="{
    ...
    <div class="grid lg:grid-cols-12 gap-6 items-end mb-12">
      <div class="lg:col-span-7">
        ...
        <h2
          class="mt-3 font-display text-xl sm:text-2xl lg:text-3xl leading-tight font-semibold text-ink tracking-tight text-balance">
          Upcoming <span class="italic text-brand-600">Events, Health Camps</span> &amp; Workshops.
        </h2>
      </div>
...
<section id="blogs" class="relative py-16 lg:py-24 bg-mist/60 overflow-hidden" x-data="{
    ...
    <div x-show="selectedArticle !== null" x-cloak style="display: none;"
      ...
      <div x-show="selectedArticle !== null" @click.away="closeArticleModal()"
        ...
        <div class="my-6 aspect-[16/9] rounded-2xl overflow-hidden bg-mist ring-1 ring-brand-200 shadow-soft">
          <img :src="selectedArticle?.img" :alt="selectedArticle?.title" class="w-full h-full object-cover">
        </div>
